...
if [[ "$action" == "create" ]]; then
  ...
  --parameters ParameterKey=MasterInstanceType,ParameterValue=t2.small.elasticsearch \
  --parameters ParameterKey=DataInstanceType,ParameterValue=t2.small.elasticsearch \
